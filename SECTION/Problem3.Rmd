...
3. Suppose $X$ is a discrete uniform random variable on the integers $-n, -n + 1, -n +2, \dots, 0, 1, 2,\dots, n$, that is, 
...
4. Which of the following is a valid CDF? (choose one; also point out what's wrong with the ones you didn't choose)
