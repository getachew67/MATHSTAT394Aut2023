...
b. If a student comes to Hall Health and says that she has a sore throat, what is the probability that she has mono? Be sure to show your steps carefully.  (Hint: please see problem 2b in `Problem2.Rmd` for help, We will deduct points for not defining events and carefully showing your work step by step. )
...
Prove result c. only. You may use the results from a. and b. without proof in your answer.